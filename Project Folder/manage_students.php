                ...
                while($row = mysqli_fetch_array($result))
                  {
                    ...
                    echo "<td> <a href=\"manage_students.php?parem=delete&amp;id={$row['rno']}\"> Delete</a> </td>";
                    echo "</tr>";
                  }
...
<?php
       if(isset($_GET['parem']) && $_GET['parem']=="delete"){
         ...
         $sql="DELETE FROM students WHERE rno='$id'";
           $result = mysqli_query($conn, $sql);
         ...
         if($result){
            ...
            echo 'alert("ERROR. Can not delete student because student has results posted.")';
            echo '</script>';
