        ...
        <ul>
            ...
            <li class="dropdown" onclick="toggleDisplay('3')">
                ...
                <div class="dropdown-content" id="3">
                    ...
                    <a href="viewallresults.php"> View All Results</a>
                </div>
            </li>
        </ul>
    </div>
    ...
    <div class="main">
        <form action="" method="post">
            <fieldset >
                ...
                <?php
                    $select_pname_query="SELECT `pname` FROM `professors`";
                    $class_result=mysqli_query($conn,$select_pname_query);
                    //select class
                    echo '<select name="professorsName">';
                    echo '<option selected disabled>Select Professor</option>';
                    
                        while($rowss = mysqli_fetch_array($class_result)) {
                            $display = $rowss['pname'];
...
<?php 
    ...
    if (isset($_POST['class_name'],$_POST['class_id'])) {
        ...
        $sql = "INSERT INTO `class` (`name`, `id`,`pname_class`) VALUES ('$name', '$id','$prof')";
