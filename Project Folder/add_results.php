    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="Exam 1">
                <input type="text" name="p2" id="" placeholder="Exam 2">
                <input type="text" name="p3" id="" placeholder="Exam 3">
                <input type="text" name="p4" id="" placeholder="HW 1">
                <input type="text" name="p5" id="" placeholder="HW 2">
