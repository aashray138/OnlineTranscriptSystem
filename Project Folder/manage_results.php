    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <?php
                    ...
                    echo'</select>'
                ?>
                <input type="text" name="rno" placeholder="WIN ID">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p1" id="" placeholder="Midterm 1">
                <input type="text" name="p2" id="" placeholder="Midterm 2">
                <input type="text" name="p3" id="" placeholder="Final Exam">
                <input type="text" name="p4" id="" placeholder="Assignment 1">
                <input type="text" name="p5" id="" placeholder="Assignment 2">
